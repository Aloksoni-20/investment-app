      ...
      <div className="max-w-4xl mx-auto text-center">
        <motion.div variants={fadeUp}>
          <div className="text-center mb-16">
            ...
            <h2 className="font-heading text-3xl md:text-5xl font-bold">Contact Us</h2>
            <div className="w-16 h-px bg-primary mx-auto mt-6" />
          </div>
        </motion.div>

        <motion.div variants={fadeUp} className="flex flex-col sm:flex-row justify-center gap-6 mb-12">
          <a
            href="mailto:info@investconnectpitch.com"
            className="flex items-center justify-center gap-2 text-muted-foreground font-body text-sm hover:text-primary transition-colors"
          >
